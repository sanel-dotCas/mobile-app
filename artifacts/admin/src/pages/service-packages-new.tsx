...
export default function ServicePackagesNewPage() {
    ...
    mutationFn: () =>
      api("/admin/service-packages", {
        ...
        body: JSON.stringify({
          ...
          serviceInterval: serviceInterval.trim() || undefined,
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">New Service Package</h1>
          <p className="text-slate-500">Build a package manually with line items</p>
        </div>
      </div>
